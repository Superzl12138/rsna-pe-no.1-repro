...
if not os.path.exists(out_dir):
    os.makedirs(out_dir)
np.save(out_dir+'pred_prob_list_seresnext101_192', np.array(pred_prob_list))
np.save(out_dir+'gt_list_seresnext101_192', np.array(gt_list))
np.save(out_dir+'loss_weight_list_seresnext101_192', np.array(loss_weight_list))

out_dir = 'weights/'
if not os.path.exists(out_dir):
    os.makedirs(out_dir)
torch.save(model.state_dict(), out_dir+'seresnext101_192')
