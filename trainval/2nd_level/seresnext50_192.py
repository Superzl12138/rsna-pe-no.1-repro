...
feature_train_path, feature_valid_path = resolve_feature_paths("seresnext50")
...
if not os.path.exists(out_dir):
    os.makedirs(out_dir)
np.save(out_dir+'pred_prob_list_seresnext50_192', np.array(pred_prob_list))
np.save(out_dir+'gt_list_seresnext50_192', np.array(gt_list))
np.save(out_dir+'loss_weight_list_seresnext50_192', np.array(loss_weight_list))
